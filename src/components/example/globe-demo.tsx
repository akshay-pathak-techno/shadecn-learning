...
export default function GlobeDemo() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-6 h-auto md:h-auto dark:bg-black bg-transparent relative w-full">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden  h-[14rem] px-4">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
